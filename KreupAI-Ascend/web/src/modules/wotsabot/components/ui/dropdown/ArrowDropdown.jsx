  ...
  return (
    <div className="relative inline-block" ref={dropdownRef}>
      <button
        ...
        className="text-sm text-white pr-2 py-2 rounded-r-md border border-blue-500  bg-blue-500 hover:bg-blue-500 transition-colors duration-150 flex items-center justify-center"
      >
        {placeholderImage && (
          <img
